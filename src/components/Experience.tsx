  ...
  const experiences = [
    {
      ...
      description: "Conducting literature review on interpretability-accuracy balance in machine learning methods, focusing on psychological studies and Generalized Additive Models.",
      highlights: [
    ...
    },
    {
      ...
      description: "Supporting student accessibility by providing comprehensive lecture notes and course materials through digital platforms.",
      highlights: [
    ...
    },
    {
      ...
      description: "Provided personalized tutoring in mathematics and statistics, focusing on effective learning strategies and problem-solving techniques.",
      highlights: [
    ...
    },
    {
      ...
      description: "Led a mixed doubles badminton team, coordinating practices and managing team dynamics to enhance performance.",
      highlights: [
            ...
            >
              <div className="grid md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                  <h3 className="text-2xl font-medium mb-2 text-white">{exp.title}</h3>
